...
for baselineCorrect = [1]
    ...
    betterLegend(h, {'d1', 'both'}, 'image');
    print(gcf, '-dpdf', sprintf('%s/figures/images_bl%d_v7.pdf', mypath, baselineCorrect));
    ...
    betterLegend(h, {'d1', 'both'}, 'image');
    print(gcf, '-dpdf', sprintf('%s/figures/images_bl%d_v8.pdf', mypath, baselineCorrect));
